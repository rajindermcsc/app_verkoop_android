...
import com.verkoop.models.DataItemDetails
...
class ProductDetailsActivity:AppCompatActivity(){
   private var imageURLLIst=ArrayList<String>()
    ...
    private fun setData(imageURLLIst: ArrayList<String>, data: DataItemDetails) {
                ...
                object : ServiceHelper.OnResponse {
                    override fun onSuccess(response: Response<*>) {
                        ...
                        val detailsResponse = response.body() as ItemDetailsResponse
                         for (i in detailsResponse.data.items_images.indices){
                             imageURLLIst.add(detailsResponse.data.items_images[i].url)
