...
import com.verkoopapp.models.SearchMultipleKeywordData
import com.verkoopapp.utils.AppConstants
import kotlinx.android.extensions.LayoutContainer
import kotlinx.android.synthetic.main.row_search_item.*

class SearchVisionDataListAdapter(private val context: Context):RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    private val mLayoutInflater:LayoutInflater= LayoutInflater.from(context)
    private var searchItemList= ArrayList<SearchMultipleKeywordData>()
...
//            }
    ...
    fun setData(searchItem: ArrayList<SearchMultipleKeywordData>) {
